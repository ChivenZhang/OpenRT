...
void mt_push_const_int(const char* name, int32_t value);
void mt_push_const_uint(const char* name, uint32_t value);
void mt_push_const_float(const char* name, float value);
void mt_push_const_vec2(const char* name, const float* value);
void mt_push_const_vec3(const char* name, const float* value);
void mt_push_const_vec4(const char* name, const float* value);
void mt_push_const_mat3(const char* name, const float* value);
void mt_push_const_mat4(const char* name, const float* value);
...
void mt_draw_mesh_task(uint32_t groupX, uint32_t groupY = 1, uint32_t groupZ = 1);
