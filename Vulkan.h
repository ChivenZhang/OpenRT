...
using vk_buffer_t = rhi_buffer_t;
using vk_buffer_desc_t = rhi_buffer_desc_t;
using vk_buffer_bind_t = rhi_buffer_bind_t;

using vk_texture_t = rhi_texture_t;
using vk_texture_desc_t = rhi_texture_desc_t;
using vk_texture_bind_t = rhi_texture_bind_t;
using vk_texture_storage_bind_t = rhi_texture_storage_bind_t;

using vk_image_t = rhi_image_t;

using vk_sampler_t = rhi_sampler_t;
using vk_sampler_desc_t = rhi_sampler_desc_t;
using vk_sampler_bind_t = rhi_sampler_bind_t;

using vk_module_t = rhi_module_t;

using vk_color_t = rhi_color_t;
using vk_pass_t = rhi_pass_t;

using vk_mesh_t = rhi_mesh_t;
using vk_meshlet_t = rhi_meshlet_t;
 ...
 */
vk_mesh_t vk_create_mesh(const float* vertices, const float* normals, const float* uvs, size_t vertex_count,
 ...
 */
vk_meshlet_t vk_create_meshlet(const float* vertices, const float* normals, const float* uvs, size_t vertex_count,
                               const unsigned int* indices, size_t index_count);
/*
