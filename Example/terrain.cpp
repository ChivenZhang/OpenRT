...
void frame(int width, int height)
{
    ...
    static auto module = rt_create_module_meshlet(nullptr, MS, FS, {.depth = {.write = true, .func = GL_LEQUAL,}, .vertex = {rt_vertex_layout, rt_normal_layout, rt_uv_layout,}, .fill_mode = GL_FILL,});
